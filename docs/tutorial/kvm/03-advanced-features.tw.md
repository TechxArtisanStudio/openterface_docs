---
title: "KVM教程 03 — 高級功能"
description: 受眾： 中級至專家 — 高級用戶功能與配置 官方 Openterface 文檔：安裝步驟、常見問題與故障排查，面向 IT 與開發者。 Openterface. Openterface.
---
...
受 AutoHotKey 啟發的腳本語言，用於在目標上自動化鍵盤和鼠標操作。
...
| Scenario | Mode |
|----------|------|
| 目標處於 BIOS/UEFI、無網絡、啟動中或已崩潰 | Hardware KVM |
...
- **自動連接：** 默認啟用。啟動時，應用掃描 5 秒並自動連接信號最強的 `kvm*` 設備。
