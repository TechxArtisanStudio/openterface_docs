...
description: "一般的な KeyMod 問題を修正します: 接続の問題、キーが登録されない、Bluetooth ペアリングの失敗、音声入力エラーなど。 Android の KeyCmd アプリに関する一般的な問題と解決策。"
...
- **バグレポート:** [Discord](https://discord.gg/techxartisan)
