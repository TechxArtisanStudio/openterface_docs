...
-   :material-feature-search-outline:{ .lg } __Specifiche e Funzionalità__
    ...
    [:octicons-arrow-right-24: Contenuto della Scatola](/products/kvmext/whats-in-the-box/)

    [:octicons-arrow-right-24: Visualizza Funzionalità](/products/kvmext/features)

    [:octicons-arrow-right-24: Installazione Hardware](/products/kvmext/hardware-installation)
...
-   :material-power-plug:{ .lg } __Come Utilizzare__
    ...
    [:octicons-arrow-right-24: Configurazione Software](/products/kvmext/software-setup)

    [:octicons-arrow-right-24: Visualizza FAQ](/products/kvmext/faq)
...
-   :material-calendar-star:{ .lg } __Aggiornamenti e Comunità__
    ...
    [:material-newspaper-variant-outline: Aggiornamenti Prodotto](/products/kvmext/updates/) / [:material-account-group-outline: Supporto Comunità](/discord) / [:material-play-circle-outline: Video YouTube](/it/videos/?p=uconsole-kvm-extension)
...
<div markdown="0">
{% include "partials/videos-grid-uconsole-kvm-extension.it.html" %}
</div>
