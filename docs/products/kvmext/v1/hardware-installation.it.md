---
title: "Installazione hardware (Legacy v1)"
...
1. Vai a [Configurazione software](/products/kvmext/software-setup/) per installare l'App Openterface.  
2. Vai a [Connetti al dispositivo target](/products/kvmext/connect-to-target/) per connettere il tuo dispositivo target.  
3. Rivedi [Funzionalità e specifiche](/products/kvmext/features/) per specifiche tecniche dettagliate.
