...
請參閲我們的 [Flatpak 安裝指南](https://github.com/TechxArtisanStudio/Openterface_QT/blob/main/docs/flatpak_installation.md) 獲取詳細步驟。
...
### **啓動 KVM 會話**
1. 在 uConsole 上啓動 Openterface 應用
2. 應用將自動檢測 KVM 擴展板
3. 通過 HDMI 連接目標設備
...
### **高級功能**
- **文本傳輸**：通過模擬按鍵快速發送文本——適用於用户名、密碼和代碼片段
...
### **啓動 KVM 會話**
1. 在您的 uConsole 上啓動 Openterface App
...
### **高級功能**
- **文本傳輸**：通過模擬按鍵快速傳輸文本—非常適合用户名、密碼和代碼片段
