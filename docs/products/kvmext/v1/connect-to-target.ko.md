...
1. [하드웨어 설치](/products/kvmext/hardware-installation/) - KVM Extension 보드의 물리적 설치
2. [소프트웨어 설정](/products/kvmext/software-setup/) - Openterface App 설치
