...
1. 前往[软件设置](/products/kvmext/software-setup/)安装 Openterface App。  
2. 前往[连接到目标设备](/products/kvmext/connect-to-target/)连接您的目标设备。  
3. 查看[功能与规格](/products/kvmext/features/)了解详细技术规格。
