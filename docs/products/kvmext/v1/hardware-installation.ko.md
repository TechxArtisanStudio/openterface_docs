...
1. [소프트웨어 설정](/products/kvmext/software-setup/)으로 이동하여 Openterface App을 설치하세요.  
2. [대상 장치에 연결](/products/kvmext/connect-to-target/)으로 이동하여 대상 장치를 연결하세요.  
3. [기능 및 사양](/products/kvmext/features/)을 검토하여 상세한 기술 사양을 확인하세요.
