---
title: "Conectar ao Dispositivo Alvo (Legacy v1)"
...
1. [Instalação de Hardware](/products/kvmext/hardware-installation/) - Instalação física da placa Extension KVM
2. [Configuração de Software](/products/kvmext/software-setup/) - Instalação do App Openterface
