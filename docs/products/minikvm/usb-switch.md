...
- **Hardware Switch**: A physical two-position toggle on the device ![Toggle Switch](https://assets.openterface.com/images/shell-icons/toggle-h-t.svg){:style="max-height:20px"} (inward = host, outward = target).  
