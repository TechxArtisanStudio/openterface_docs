...
-   더 긴 케이블의 경우 다음을 통해 전원을 주입하세요:
    -   USB-A 수-수 케이블
    -   [확장 핀](/products/minikvm/extension-pins/)
    -   USB-C Y 스플리터
...
자세한 내용은 [키보드 및 마우스 제어 문제 해결](/products/minikvm/support/keyboard-mouse-control/)을 참조하세요.
...
직접적으로는 안 되지만, [확장 핀](/products/minikvm/extension-pins/)을 통해 향후 ATX 제어 모듈이 가능합니다.
...
- **macOS:** [진단 자기 점검 가이드 (macOS)](/products/minikvm/support/diagnostic-self-check/) — 설정 → 고급 및 디버그 → 진단 도구 열기
- **Windows:** [진단 자기 점검 가이드 (Windows)](/products/minikvm/support/diagnostic-self-check-windows/) — 고급 → 하드웨어 진단
...
단계별 설명은 [진단 자기 점검 가이드 (macOS)](/products/minikvm/support/diagnostic-self-check/) 또는 [진단 자기 점검 가이드 (Windows)](/products/minikvm/support/diagnostic-self-check-windows/)를 참조하세요.

**:material-chat-question:{ .faq } USB 허브 문제**

전압 강하로 인한 불안정성을 피하기 위해 **전원 공급 허브**를 사용하세요. 무전원 허브는 전력 공급 부족과 HID(키보드/마우스) 동작 불안정을 유발할 수 있습니다. 자세한 내용은 [키보드 및 마우스 제어 문제 해결](/products/minikvm/support/keyboard-mouse-control/)을 참조하세요.

**:material-chat-question:{ .faq } 앱에 비디오가 표시되지 않거나 제어가 응답하지 않음**

1. 모든 케이블을 분리하고 몇 초 기다린 후 다시 연결하세요.
2. HID 문제(케이블, 허브, HID 리셋)에 대해 [키보드 및 마우스 제어 문제 해결](/products/minikvm/support/keyboard-mouse-control/)을 확인하세요.
3. 장치를 검증하려면 [진단 자기 점검](/products/minikvm/support/diagnostic-self-check/) (macOS) 또는 [하드웨어 진단](/products/minikvm/support/diagnostic-self-check-windows/) (Windows)을 실행하세요.
...
-   최신 호스트 앱 확인
-   [진단 자기 점검](/products/minikvm/support/diagnostic-self-check/)을 실행하여 로그 캡처
