...
-   For longer cables, inject power via:
    ...
    -   [Extension pin](/products/minikvm/extension-pins/)
    -   USB-C Y-splitter
...
For full details, see [Troubleshooting Keyboard and Mouse Control Issues](/products/minikvm/support/keyboard-mouse-control/).
...
Not directly, but [extension pins](/products/minikvm/extension-pins/) allow future ATX control modules.
...
- **macOS:** [Diagnostic Self-Check Guide (macOS)](/products/minikvm/support/diagnostic-self-check/) — Settings → Advanced & Debug → Open Diagnostics Tool
- **Windows:** [Diagnostic Self-Check Guide (Windows)](/products/minikvm/support/diagnostic-self-check-windows/) — Advanced → Hardware Diagnostics
...
See the [Diagnostic Self-Check Guide (macOS)](/products/minikvm/support/diagnostic-self-check/) or [Diagnostic Self-Check Guide (Windows)](/products/minikvm/support/diagnostic-self-check-windows/) for step-by-step instructions.

**:material-chat-question:{ .faq } USB hub issues**

Use a **powered hub** to avoid voltage drops causing instability. Unpowered hubs can lead to insufficient power delivery and erratic HID (keyboard/mouse) behavior. See [Keyboard and Mouse Control troubleshooting](/products/minikvm/support/keyboard-mouse-control/) for details.
...
2. Check [Keyboard and Mouse Control troubleshooting](/products/minikvm/support/keyboard-mouse-control/) for HID issues (cables, hubs, HID reset).
3. Run the [diagnostic self-check](/products/minikvm/support/diagnostic-self-check/) (macOS) or [Hardware Diagnostics](/products/minikvm/support/diagnostic-self-check-windows/) (Windows) to verify the device.
...
-   Run the [diagnostic self-check](/products/minikvm/support/diagnostic-self-check/) to capture logs
