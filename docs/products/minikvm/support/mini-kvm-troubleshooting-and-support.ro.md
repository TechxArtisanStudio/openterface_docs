...
- [Tastatura și mouse-ul nu pot controla computerul țintă](/products/minikvm/support/keyboard-mouse-control/)
- [Problema tastatură și mouse – Analiză tehnică](/products/minikvm/updates/260128-keyboard-mouse-issue-analysis/)
