...
description: Häufig gestellte Pytania zum Mini-KVM, die Funkcje, Kompatibilität, Fehlerbehebung i zukünftige Pläne abdecken. Willkommen zu den FAQs dla unser Flaggschiff…
...
Details siehe [Troubleshooting Tastatur- i Maussteuerung](/products/minikvm/support/keyboard-mouse-control/).
...
- **macOS:** [Diagnose Selbsttest Przewodnik (macOS)](/products/minikvm/support/diagnostic-self-check/) — Einstellungen → Erweitert & Debug → Diagnose-Tool öffnen
- **Windows:** [Diagnose Selbsttest Przewodnik (Windows)](/products/minikvm/support/diagnostic-self-check-windows/) — Erweitert → Sprzęt-Diagnose
...
Schritt-dla-Schritt-Przewodnik: [Diagnose Selbsttest Przewodnik (macOS)](/products/minikvm/support/diagnostic-self-check/) lub [Diagnose Selbsttest Przewodnik (Windows)](/products/minikvm/support/diagnostic-self-check-windows/).

**:material-chat-question:{ .faq } USB-Hub-Probleme**

Verwenden Sie einen **aktiven Hub**, um Spannungsabfälle zu vermeiden. Unversorgte Hubs können zu unzureichender Stromversorgung i instabilem HID-Verhalten (Tastatur/Maus) führen. Details: [Troubleshooting Tastatur- i Maussteuerung](/products/minikvm/support/keyboard-mouse-control/).
...
2. [Troubleshooting Tastatur- i Maussteuerung](/products/minikvm/support/keyboard-mouse-control/) dla HID-Probleme prüfen (Kabel, Hubs, HID-Reset).
3. [Diagnose-Selbsttest](/products/minikvm/support/diagnostic-self-check/) (macOS) lub [Sprzęt-Diagnose](/products/minikvm/support/diagnostic-self-check-windows/) (Windows) ausführen.
