...
-   Pentru cabluri mai lungi, injectați alimentare prin:
    ...
    -   [Pinuri de extensie](/products/minikvm/extension-pins/)
    -   Divizor USB-C Y
...
Pentru detalii, consultați [Depanare control tastatură și mouse](/products/minikvm/support/keyboard-mouse-control/).
...
Nu direct, dar [pinurile de extensie](/products/minikvm/extension-pins/) permit module viitoare de control ATX.
...
- **macOS:** [Ghid pentru verificare auto-diagnostic (macOS)](/products/minikvm/support/diagnostic-self-check/) — Setări → Avansat și Debug → Deschide Tool pentru Diagnosticare
- **Windows:** [Ghid pentru verificare auto-diagnostic (Windows)](/products/minikvm/support/diagnostic-self-check-windows/) — Avansat → Diagnostic Hardware
...
Instrucțiuni pas cu pas: [Ghid pentru verificare auto-diagnostic (macOS)](/products/minikvm/support/diagnostic-self-check/) sau [Ghid pentru verificare auto-diagnostic (Windows)](/products/minikvm/support/diagnostic-self-check-windows/).

**:material-chat-question:{ .faq } Probleme hub USB**

Folosiți un **hub alimentat** pentru a evita scăderile de tensiune. Hub-urile nealimentate pot cauza alimentare insuficientă și comportament erratic al HID (tastatură/maus). Consultați [Depanare control tastatură și mouse](/products/minikvm/support/keyboard-mouse-control/).
...
2. Verificați [Depanare control tastatură și mouse](/products/minikvm/support/keyboard-mouse-control/) pentru probleme HID (cabluri, hub-uri, resetare HID).
3. Rulați [verificarea auto-diagnostic](/products/minikvm/support/diagnostic-self-check/) (macOS) sau [Diagnostic Hardware](/products/minikvm/support/diagnostic-self-check-windows/) (Windows) pentru a verifica dispozitivul.
...
-   Rulați [verificarea auto-diagnostic](/products/minikvm/support/diagnostic-self-check/) pentru a captura loguri
