...
description: Häufig gestellte Vragen zum Mini-KVM, die Functies, Kompatibilität, Fehlerbehebung en zukünftige Pläne abdecken. Willkommen zu den FAQs voor unser… Openterface.
...
Details siehe [Troubleshooting Tastatur- en Maussteuerung](/products/minikvm/support/keyboard-mouse-control/).
...
- **macOS:** [Diagnose Selbsttest Handleiding (macOS)](/products/minikvm/support/diagnostic-self-check/) — Einstellungen → Erweitert & Debug → Diagnose-Tool öffnen
- **Windows:** [Diagnose Selbsttest Handleiding (Windows)](/products/minikvm/support/diagnostic-self-check-windows/) — Erweitert → Hardware-Diagnose
...
Schritt-voor-Schritt-Handleiding: [Diagnose Selbsttest Handleiding (macOS)](/products/minikvm/support/diagnostic-self-check/) of [Diagnose Selbsttest Handleiding (Windows)](/products/minikvm/support/diagnostic-self-check-windows/).

**:material-chat-question:{ .faq } USB-Hub-Probleme**

Verwenden Sie einen **aktiven Hub**, um Spannungsabfälle zu vermeiden. Unversorgte Hubs können zu unzureichender Stromversorgung en instabilem HID-Verhalten (Tastatur/Maus) führen. Details: [Troubleshooting Tastatur- en Maussteuerung](/products/minikvm/support/keyboard-mouse-control/).
...
2. [Troubleshooting Tastatur- en Maussteuerung](/products/minikvm/support/keyboard-mouse-control/) voor HID-Probleme prüfen (Kabel, Hubs, HID-Reset).
3. [Diagnose-Selbsttest](/products/minikvm/support/diagnostic-self-check/) (macOS) of [Hardware-Diagnose](/products/minikvm/support/diagnostic-self-check-windows/) (Windows) ausführen.
