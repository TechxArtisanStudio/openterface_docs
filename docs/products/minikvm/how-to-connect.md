...
![to-host](https://assets.openterface.com/images/product/to-host.svg){:style="max-height:200px"}
![to-target](https://assets.openterface.com/images/product/to-target.svg){:style="max-height:200px"}
...
![host-side](https://assets.openterface.com/images/product/host-htc.svg){:style="max-width:300px"} ![target-side](https://assets.openterface.com/images/product/target-htc.svg){:style="max-width:300px"}
...
⑤ ![Toggle Switch](https://assets.openterface.com/images/shell-icons/toggle-h-t.svg){:style="max-height:20px"} **Toggle Switch**: Switch USB-A port between host/target

⑥ ![Extension Pins](https://assets.openterface.com/images/shell-icons/pins.svg){:style="max-height:15px"} **Extension Pins**: Developer access (see [Extension Pins](../extension-pins))