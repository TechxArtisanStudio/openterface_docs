...
<div class="doc-minikvm-packages">
  ...
  <img src="https://assets.openterface.com/images/cover/mini-kvm-toolkit.webp" alt="Openterface Mini-KVM Basic- und Toolkit-Pakete" class="doc-minikvm-packages__photo skip-lightbox" loading="lazy" />
  <div class="doc-minikvm-packages__grid">
    <div class="doc-minikvm-packages__card">
      ...
      <p class="doc-minikvm-packages__desc">Mini-KVM Gerät und Schnellstartanleitung — eigene hochwertige Kabel mitbringen</p>
    </div>
    <div class="doc-minikvm-packages__card doc-minikvm-packages__card--featured">
      ...
      <p class="doc-minikvm-packages__desc">Komplettset mit getesteten Kabeln, Toolkit-Tasche und Zubehör — bestes Preis-Leistungs-Verhältnis</p>
    </div>
  </div>
  <p class="doc-minikvm-packages__note">Beide Pakete enthalten dasselbe Mini-KVM Kern-Gerät — Basic für das Wesentliche oder Toolkit für ein komplettes, kompatibles Setup.</p>
</div>
...
<div style="text-align: center; margin: 20px 0 10px 0;">
  <div class="carousel-funding-stats" style="display: inline-flex; justify-content: center;">
    ...
    <span class="funding-backers"><span class="funding-backers-count">3,775</span> <span>Unterstützer</span></span>
  </div>
</div>
...
-   :material-feature-search-outline:{ .lg } __Spezifikationen und Funktionen__
    ...
    [:octicons-arrow-right-24: Funktionen Anzeigen](/products/minikvm/features)
...
-   :material-calendar-star:{ .lg } __Updates und Veranstaltungen__
    ...
    [:material-star-outline: Bewertungen](/products/minikvm/reviews/) / [:material-newspaper-variant-outline: Medien](/products/minikvm/reviews/) / [:material-play-circle-outline: YouTube Videos](/de/videos/?p=minikvm) / [:material-newspaper-variant-outline: Insgesamt Updates {{ config.extra.minikvm_updates }}](/products/minikvm/updates) / [:material-trophy-outline: USB KVM DIY Wettbewerb 2024](/products/minikvm/updates) / [:material-account-group-outline: Ausstellung](/products/minikvm/updates)
