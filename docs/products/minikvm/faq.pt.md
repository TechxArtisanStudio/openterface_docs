...
description: Perguntas frequentes sobre o Mini-KVM, cobrindo recursos, compatibilidade, solução de problemas e planos futuros. Bem-vindo às perguntas frequentes do nosso…
...
-   Para cabos mais longos, injete energia via:
    ...
    -   [Pinos de extensão](/products/minikvm/extension-pins/)
    -   Divisor USB-C Y
...
Para detalhes, veja [Solução de problemas de controle de teclado e mouse](/products/minikvm/support/keyboard-mouse-control/).
...
Não diretamente, mas os [pinos de extensão](/products/minikvm/extension-pins/) permitem futuros módulos de controle ATX.
...
- **macOS:** [Guia de Autoverificação Diagnóstica (macOS)](/products/minikvm/support/diagnostic-self-check/) — Configurações → Avançado & Debug → Abrir Ferramenta de Diagnóstico
- **Windows:** [Guia de Autoverificação Diagnóstica (Windows)](/products/minikvm/support/diagnostic-self-check-windows/) — Avançado → Hardware Diagnostics
...
Instruções passo a passo: [Guia de Autoverificação Diagnóstica (macOS)](/products/minikvm/support/diagnostic-self-check/) ou [Guia de Autoverificação Diagnóstica (Windows)](/products/minikvm/support/diagnostic-self-check-windows/).

**:material-chat-question:{ .faq } Problemas de hub USB**

Use um **hub alimentado** para evitar quedas de tensão. Hubs não alimentados podem causar fornecimento insuficiente e comportamento errático do HID (teclado/mouse). Veja [Solução de problemas de controle de teclado e mouse](/products/minikvm/support/keyboard-mouse-control/).
...
2. Verifique [Solução de problemas de controle de teclado e mouse](/products/minikvm/support/keyboard-mouse-control/) para problemas HID (cabos, hubs, redefinição HID).
3. Execute a [autoverificação diagnóstica](/products/minikvm/support/diagnostic-self-check/) (macOS) ou [Hardware Diagnostics](/products/minikvm/support/diagnostic-self-check-windows/) (Windows) para verificar o dispositivo.
...
-   Execute a [autoverificação diagnóstica](/products/minikvm/support/diagnostic-self-check/) para capturar logs
