...
-   :material-feature-search-outline:{ .lg } __Spezifikationen & Funktionen__
    ...
    [:octicons-arrow-right-24: Funktionen anzeigen](/products/keymod/features/)

    [:octicons-arrow-right-24: Lieferumfang](/products/keymod/whats-in-the-box/)

    [:octicons-arrow-right-24: Verbindung herstellen](/products/keymod/how-to-connect/)
...
-   :material-calendar-star:{ .lg } __Pre-Launch & Updates__
    ...
    [:material-newspaper-variant-outline: Produkt-Updates](/products/keymod/updates/) / [:material-play-circle-outline: YouTube-Videos](/videos/?p=keymod) / [:material-account-group-outline: Unten abonnieren](/products/keymod/#product-signup-form)
