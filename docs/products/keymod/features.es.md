...
KeyMod está actualmente en desarrollo de pre-lanzamiento. Estamos refinando el hardware y el software. Suscríbete en la [página del producto](/products/keymod/) para mantenerte informado sobre el progreso y las notificaciones de lanzamiento.
