...
-   :material-feature-search-outline:{ .lg } __Specifiche e funzionalità__
    ...
    [:octicons-arrow-right-24: Visualizza funzionalità](/products/keymod/features)

    [:octicons-arrow-right-24: Contenuto della confezione](/products/keymod/whats-in-the-box/)

    [:octicons-arrow-right-24: Come collegare](/products/keymod/how-to-connect/)
...
-   :material-power-plug:{ .lg } __Come usare__
    ...
    [:octicons-arrow-right-24: Casi d'uso](/products/keymod/use-cases/)

    [:octicons-arrow-right-24: Visualizza FAQ](/products/keymod/faq)
...
-   :material-calendar-star:{ .lg } __Pre-lancio e aggiornamenti__
    ...
    [:material-newspaper-variant-outline: Aggiornamenti prodotto](/products/keymod/updates/) / [:material-play-circle-outline: Video YouTube](/videos/?p=keymod) / [:material-account-group-outline: Iscriviti qui sotto](/products/keymod/#product-signup-form)
