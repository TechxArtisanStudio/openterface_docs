...
-   :material-feature-search-outline:{ .lg } __Specificații și funcționalități__
    ...
    [:octicons-arrow-right-24: Cum se conectează](/products/keymod/how-to-connect/)
...
-   :material-power-plug:{ .lg } __Cum se folosește__
    ...
    [:octicons-arrow-right-24: Cazuri de utilizare](/products/keymod/use-cases/)

    [:octicons-arrow-right-24: Vizualizați întrebări frecvente](/products/keymod/faq)
...
-   :material-calendar-star:{ .lg } __Pre-lansare și actualizări__
    ...
    [:material-newspaper-variant-outline: Actualizări produs](/products/keymod/updates/) / [:material-play-circle-outline: Videoclipuri YouTube](/videos/?p=keymod) / [:material-account-group-outline: Abonați-vă mai jos](/products/keymod/#product-signup-form)
