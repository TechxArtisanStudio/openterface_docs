...
description: KeyMod 系列是一款紧凑的 USB + 蓝牙 HID 模拟器，可将您的手机变成便携式键盘和触控板。即插即用，100% 开源。适用于信息亭、智能电视和快速工作流快捷方式。 继 2024 年 和 2025 年 活动成功后，我们带来了一款新的日常控制工具：Openterface KeyMod。 KeyMod…
...
<div class="doc-keymod-variants">
  <p class="doc-keymod-variants__title">计划版本</p>
  ...
  <div class="doc-keymod-variants__grid">
    <div class="doc-keymod-variants__card">
      ...
      <p class="doc-keymod-variants__name">2 合 1 连接器版本</p>
      <p class="doc-keymod-variants__desc">组合 USB A + USB C 插头设计，广泛兼容笔记本电脑、平板电脑和手机</p>
    </div>
    <div class="doc-keymod-variants__card">
      ...
      <p class="doc-keymod-variants__desc">专用于现代设备的 USB C 插头，便于整洁的线缆管理</p>
    </div>
  </div>
  <p class="doc-keymod-variants__note">两个版本共享相同的核心功能：蓝牙 HID 键盘和鼠标、自定义配置、宏和手柄模式。</p>
</div>
...
-   :material-feature-search-outline:{ .lg } __规格与功能__
    ...
    [:octicons-arrow-right-24: 包装内容](/products/keymod/whats-in-the-box/)

    [:octicons-arrow-right-24: 如何连接](/products/keymod/how-to-connect/)
...
-   :material-power-plug:{ .lg } __使用方法__
    ...
    [:octicons-arrow-right-24: 下载 KeyCmd 应用](/app)

    [:octicons-arrow-right-24: 如何连接](/products/keymod/how-to-connect)

    [:octicons-arrow-right-24: 使用场景](/products/keymod/use-cases/)

    [:octicons-arrow-right-24: 查看常见问题](/products/keymod/faq)
...
-   :material-calendar-star:{ .lg } __预发布与更新__
    ...
    [:material-newspaper-variant-outline: 产品更新](/products/keymod/updates/) / [:material-play-circle-outline: YouTube 视频](/videos/?p=keymod) / [:material-account-group-outline: 在下方订阅](/products/keymod/#product-signup-form)
