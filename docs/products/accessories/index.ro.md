...
-   :material-cable-data:{ .lg } __Cabluri__
    ...
    [:octicons-arrow-right-24: Cablu Convertor VGA la HDMI](/products/accessories/vga-to-hdmi-cable)

    [:octicons-arrow-right-24: Cablu USB-C din Nylon Îmbunătățit](/products/accessories/nylong-c-to-c-150)

    [:octicons-arrow-right-24: Cablu Type-C la Type-C cu Adaptor](/products/accessories/type-c-to-c-cable-with-adapter)

    [:octicons-arrow-right-24: Cablu Type-C la USB-A cu Adaptor](/products/accessories/black-c-to-a-30)

    [:octicons-arrow-right-24: Cablu HDMI Tată-la-Tată](/products/accessories/hdmi-male-to-male-cable)
...
-   :material-bag-personal:{ .lg } __Soluții de Depozitare__
    ...
    [:octicons-arrow-right-24: Geantă pentru Unelte Openterface](/products/accessories/openterface-toolkit-bag)
