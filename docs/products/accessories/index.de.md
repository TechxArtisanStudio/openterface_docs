...
-   :material-cable-data:{ .lg } __Kabel__
    ...
    [:octicons-arrow-right-24: Type-C zu Type-C Kabel mit Adapter](/products/accessories/type-c-to-c-cable-with-adapter)

    [:octicons-arrow-right-24: Type-C zu USB-A Kabel mit Adapter](/products/accessories/black-c-to-a-30)
