...
-   :material-cable-data:{ .lg } __Câbles__
    ...
    [:octicons-arrow-right-24: Câble Convertisseur VGA vers HDMI](/products/accessories/vga-to-hdmi-cable)

    [:octicons-arrow-right-24: Câble USB-C en Nylon Amélioré](/products/accessories/nylong-c-to-c-150)

    [:octicons-arrow-right-24: Câble Type-C vers Type-C avec Adaptateur](/products/accessories/type-c-to-c-cable-with-adapter)

    [:octicons-arrow-right-24: Câble Type-C vers USB-A avec Adaptateur](/products/accessories/black-c-to-a-30)

    [:octicons-arrow-right-24: Câble HDMI Mâle-Mâle](/products/accessories/hdmi-male-to-male-cable)
...
-   :material-bag-personal:{ .lg } __Solutions de Rangement__
    ...
    [:octicons-arrow-right-24: Sac à Outils Openterface](/products/accessories/openterface-toolkit-bag)
