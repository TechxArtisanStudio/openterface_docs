...
-   :material-cable-data:{ .lg } __Cables__
    ...
    [:octicons-arrow-right-24: VGA to HDMI Converter Cable](/products/accessories/vga-to-hdmi-cable)

    [:octicons-arrow-right-24: Upgraded Nylon USB-C Cable](/products/accessories/nylong-c-to-c-150)

    [:octicons-arrow-right-24: Type-C to Type-C Cable with Adapter](/products/accessories/type-c-to-c-cable-with-adapter)

    [:octicons-arrow-right-24: Type-C to USB-A Cable with Adapter](/products/accessories/black-c-to-a-30)

    [:octicons-arrow-right-24: HDMI Male-to-Male Cable](/products/accessories/hdmi-male-to-male-cable)
...
-   :material-bag-personal:{ .lg } __Storage Solutions__
    ...
    [:octicons-arrow-right-24: Openterface Toolkit Bag](/products/accessories/openterface-toolkit-bag)
