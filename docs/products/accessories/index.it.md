...
-   :material-cable-data:{ .lg } __Cavi__
    ...
    [:octicons-arrow-right-24: Cavo Convertitore VGA a HDMI](/products/accessories/vga-to-hdmi-cable)

    [:octicons-arrow-right-24: Cavo USB-C in Nylon Aggiornato](/products/accessories/nylong-c-to-c-150)

    [:octicons-arrow-right-24: Cavo Type-C a Type-C con Adattatore](/products/accessories/type-c-to-c-cable-with-adapter)

    [:octicons-arrow-right-24: Cavo Type-C a USB-A con Adattatore](/products/accessories/black-c-to-a-30)

    [:octicons-arrow-right-24: Cavo HDMI Maschio-Maschio](/products/accessories/hdmi-male-to-male-cable)
...
-   :material-bag-personal:{ .lg } __Soluzioni di Archiviazione__
    ...
    [:octicons-arrow-right-24: Borsa per Attrezzi Openterface](/products/accessories/openterface-toolkit-bag)
