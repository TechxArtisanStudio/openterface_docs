...
??? info "Étapes pour corriger"
    ...
    1. **Connecter l'alimentation USB**
        - Branchez le connecteur USB dans un port USB alimenté (tel que le [port USB commutatif](/products/minikvm/usb-switch/) du Mini-KVM ou directement dans l'ordinateur).
