...
??? info "Passaggi per risolvere"
    ...
    1. **Collegare l'alimentazione USB**
        - Inserisci il connettore USB in una porta USB alimentata (come la [porta USB commutabile](/products/minikvm/usb-switch/) del Mini-KVM o direttamente nel computer).
