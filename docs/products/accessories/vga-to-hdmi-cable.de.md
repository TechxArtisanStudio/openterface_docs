...
??? info "Schritte zur Behebung"
    ...
    1. **USB-Stromversorgung verbinden**
        - Stecken Sie den USB-Connector in einen mit Strom versorgten USB-Port (wie den [umschaltbaren USB-Port](/products/minikvm/usb-switch/) des Mini-KVM oder direkt in den Computer).
