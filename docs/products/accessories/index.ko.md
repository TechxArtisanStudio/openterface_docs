...
-   :material-cable-data:{ .lg } __케이블__
    ...
    [:octicons-arrow-right-24: VGA to HDMI 변환 케이블](/products/accessories/vga-to-hdmi-cable)

    [:octicons-arrow-right-24: 업그레이드 나일론 USB-C 케이블](/products/accessories/nylong-c-to-c-150)

    [:octicons-arrow-right-24: 어댑터 포함 타입-C to 타입-C 케이블](/products/accessories/type-c-to-c-cable-with-adapter)

    [:octicons-arrow-right-24: 어댑터 포함 타입-C to USB-A 케이블](/products/accessories/black-c-to-a-30)

    [:octicons-arrow-right-24: HDMI 암-암 케이블](/products/accessories/hdmi-male-to-male-cable)
...
-   :material-bag-personal:{ .lg } __보관 솔루션__
    ...
    [:octicons-arrow-right-24: Openterface 툴킷 가방](/products/accessories/openterface-toolkit-bag)
