...
-   :material-cable-data:{ .lg } __Cables__
    ...
    [:octicons-arrow-right-24: Cable Convertidor VGA a HDMI](/products/accessories/vga-to-hdmi-cable)

    [:octicons-arrow-right-24: Cable USB-C de Nylon Mejorado](/products/accessories/nylong-c-to-c-150)

    [:octicons-arrow-right-24: Cable Type-C a Type-C con Adaptador](/products/accessories/type-c-to-c-cable-with-adapter)

    [:octicons-arrow-right-24: Cable Type-C a USB-A con Adaptador](/products/accessories/black-c-to-a-30)

    [:octicons-arrow-right-24: Cable HDMI Macho a Macho](/products/accessories/hdmi-male-to-male-cable)
...
-   :material-bag-personal:{ .lg } __Soluciones de Almacenamiento__
    ...
    [:octicons-arrow-right-24: Bolsa de Herramientas Openterface](/products/accessories/openterface-toolkit-bag)
