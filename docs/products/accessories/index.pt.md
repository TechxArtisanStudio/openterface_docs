...
-   :material-cable-data:{ .lg } __Cabos__
    ...
    [:octicons-arrow-right-24: Cabo Conversor VGA para HDMI](/products/accessories/vga-to-hdmi-cable)

    [:octicons-arrow-right-24: Cabo USB-C de Nylon Atualizado](/products/accessories/nylong-c-to-c-150)

    [:octicons-arrow-right-24: Cabo Type-C para Type-C com Adaptador](/products/accessories/type-c-to-c-cable-with-adapter)

    [:octicons-arrow-right-24: Cabo Type-C para USB-A com Adaptador](/products/accessories/black-c-to-a-30)

    [:octicons-arrow-right-24: Cabo HDMI Macho para Macho](/products/accessories/hdmi-male-to-male-cable)
...
-   :material-bag-personal:{ .lg } __Soluções de Armazenamento__
    ...
    [:octicons-arrow-right-24: Bolsa de Ferramentas Openterface](/products/accessories/openterface-toolkit-bag)
