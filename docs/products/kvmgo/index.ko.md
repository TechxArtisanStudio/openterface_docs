...
<div style="text-align: center; margin: 20px 0 10px 0;">
  <div class="carousel-funding-stats" style="display: inline-flex; justify-content: center;">
    ...
    <span class="funding-backers"><span class="funding-backers-count">478</span> <span>후원자</span></span>
  </div>
</div>
...
-   :material-feature-search-outline:{ .lg } __사양 및 기능__
    ...
    [:octicons-arrow-right-24: 기능 보기](/products/kvmgo/features)

    [:octicons-arrow-right-24: 패키지 내용](/products/kvmgo/whats-in-the-box/)
...
-   :material-power-plug:{ .lg } __사용 방법__
    ...
    [:octicons-arrow-right-24: 연결 방법](/products/kvmgo/how-to-connect)

    [:octicons-arrow-right-24: MicroSD 카드 전환](/products/kvmgo/microsd-switch)

    [:octicons-arrow-right-24: FAQ 보기](/products/kvmgo/faq)
...
-   :material-calendar-star:{ .lg } __프리런치 및 업데이트__
    ...
    [:material-account-group-outline: 대기 목록 참여](https://forms.gle/yaS1F5E5MSo8DWNZ6) / [:material-trophy-outline: 베타 테스팅 프로그램](https://forms.gle/yaS1F5E5MSo8DWNZ6) / [:material-newspaper-variant-outline: 제품 업데이트](/products/kvmgo/updates)
