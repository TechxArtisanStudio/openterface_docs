...
KVM-Go シリーズは量産および出荷段階に入っています。完成品は Mouser の倉庫へ輸送中で、Crowd Supply のバッカーへの発送も間もなく開始されます。[Crowd Supply で予約注文]({{ config.extra.kvmgo_purchase_link }})してください。

> **注意：** VGA モデルは引き続き開発中です。量産が進むにつれ、他の詳細が更新される場合があります。
