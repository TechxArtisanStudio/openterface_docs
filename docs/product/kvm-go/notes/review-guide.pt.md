...
Obrigado por dedicar tempo a testar o nosso próximo produto **[Openterface KVM-Go](https://openterface.com/product/kvm-go/)**.
...
Para melhor desempenho e compatibilidade, use a **versão mais recente** do [software Openterface](https://openterface.com/app/overview/) da nossa página GitHub Releases. Atualizamos frequentemente, e versões mais antigas podem não corresponder ao firmware do seu protótipo.
