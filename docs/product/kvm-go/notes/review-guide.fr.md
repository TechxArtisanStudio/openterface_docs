...
Merci d'avoir pris le temps de tester notre produit à venir **[Openterface KVM-Go](https://openterface.com/product/kvm-go/)**.
...
Pour les meilleures performances et compatibilité, veuillez utiliser la **dernière version** du [logiciel Openterface](https://openterface.com/app/overview/) depuis notre page GitHub Releases. Nous mettons à jour fréquemment, et les anciennes versions peuvent ne pas correspondre au firmware de votre prototype.
