...
Yakında çıkacak ürünümüz **[Openterface KVM-Go](https://openterface.com/product/kvm-go/)**'yu test etmek için zaman ayırdığınız için teşekkürler.
...
En iyi performans ve uyumluluk için GitHub Releases sayfamızdaki [Openterface yazılımının](https://openterface.com/app/overview/) **en son sürümünü** kullanın. Sık güncelliyoruz ve eski sürümler prototipinizin firmware'i ile eşleşmeyebilir.
