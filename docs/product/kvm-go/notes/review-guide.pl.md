...
Dziękujemy za poświęcenie czasu na test naszego nadchodzącego produktu **[Openterface KVM-Go](https://openterface.com/product/kvm-go/)**.
...
Dla najlepszej wydajności i kompatybilności używaj **najnowszej wersji** [oprogramowania Openterface](https://openterface.com/app/overview/) ze strony GitHub Releases. Często aktualizujemy, a starsze wersje mogą nie pasować do firmware prototypu.
