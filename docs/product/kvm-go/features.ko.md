...
KVM-Go 시리즈는 본격적인 생산 및 출고 단계에 있습니다. 완제품이 Mouser 창고로 운송 중이며, Crowd Supply 후원자들도 곧 제품을 받게 됩니다. [Crowd Supply에서 사전 주문]({{ config.extra.kvmgo_purchase_link }})하세요.

> **참고:** VGA 모델은 아직 개발 중이며, 양산이 진행되면서 다른 세부 사항이 업데이트될 수 있습니다.
