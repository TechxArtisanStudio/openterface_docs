...
-   :material-feature-search-outline:{ .lg } __Spezifikationen ve Özellikler__
    ...
    [:octicons-arrow-right-24: Özellikler Anzeigen](/product/uconsole-kvm-extension/features)

    [:octicons-arrow-right-24: Donanım-Kurulum](/product/uconsole-kvm-extension/hardware-installation)
...
-   :material-power-plug:{ .lg } __Verwendung__
    ...
    [:octicons-arrow-right-24: Yazılım-Einrichtung](/product/uconsole-kvm-extension/software-setup)
...
-   :material-calendar-star:{ .lg } __Güncellemeler ve Community__
    ...
    [:material-newspaper-variant-outline: Ürün-Güncellemeler](/product/uconsole-kvm-extension/updates/) / [:material-account-group-outline: Community-Destek](/discord) / [:material-play-circle-outline: YouTube Videos](/tr/videos/?p=uconsole-kvm-extension)
