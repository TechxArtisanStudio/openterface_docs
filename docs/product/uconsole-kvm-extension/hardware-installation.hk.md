---
title: "硬件安裝"
description: "Openterface KVM Extension for uConsole 的逐步硬件安裝指南。學習如何在 uConsole 的擴展槽中正確安裝擴展板，並提供詳細的安全指南。"
...
1. 前往[軟件設置](/product/uconsole-kvm-extension/software-setup/)安裝 Openterface App。  
2. 前往[連接到目標設備](/product/uconsole-kvm-extension/connect-to-target/)連接您的目標設備。  
3. 查看[功能與規格](/product/uconsole-kvm-extension/features/)瞭解詳細技術規格。
