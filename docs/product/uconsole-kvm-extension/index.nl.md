...
-   :material-feature-search-outline:{ .lg } __Spezifikationen en Functies__
    ...
    [:octicons-arrow-right-24: Functies Anzeigen](/product/uconsole-kvm-extension/features)

    [:octicons-arrow-right-24: Hardware-Installatie](/product/uconsole-kvm-extension/hardware-installation)
...
-   :material-calendar-star:{ .lg } __Updates en Community__
    ...
    [:material-newspaper-variant-outline: Product-Updates](/product/uconsole-kvm-extension/updates/) / [:material-account-group-outline: Community-Ondersteuning](/discord) / [:material-play-circle-outline: YouTube Videos](/nl/videos/?p=uconsole-kvm-extension)
