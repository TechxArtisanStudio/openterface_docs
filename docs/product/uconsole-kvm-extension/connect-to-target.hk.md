...
1. [硬件安裝](/product/uconsole-kvm-extension/hardware-installation/) - KVM Extension板的物理安裝
2. [軟件設置](/product/uconsole-kvm-extension/software-setup/) - Openterface App的安裝
