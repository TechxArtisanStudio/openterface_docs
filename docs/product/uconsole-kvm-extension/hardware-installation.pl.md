...
1. Gehen Sie zu [Oprogramowanie-Setup](/product/uconsole-kvm-extension/software-setup/), um die Openterface App zu installieren.  
2. Gehen Sie zu [Mit Zielgerät verbinden](/product/uconsole-kvm-extension/connect-to-target/), um Ihr Zielgerät zu verbinden.  
3. Überprüfen Sie [Funkcje & Spezifikationen](/product/uconsole-kvm-extension/features/) dla detaillierte technische Spezifikationen.
