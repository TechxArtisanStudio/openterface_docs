...
description: "Schritt-لـ-Schritt-دليل zur Einrichtung von Openterface Mini-KVM. Lernen Sie, wie Sie Ihren Host-Computer و Ihr Zielgerät مع detaillierten Anweisungen لـ USB-C-, HDMI- و Peripheriegeräte-الاتصالen verbinden. Enthält Schnittstellenbeschreibungen و wichtige Einrichtungstipps."
keywords: "Mini-KVM Einrichtung, KVM الاتصالsanleitung, USB-C KVM Einrichtung, HDMI KVM الاتصال, KVM التثبيتsanleitung, Computer-Peripheriegeräte Einrichtung, USB-Gerät الاتصال, KVM Schnittstellenanleitung, Headless-Computer Einrichtung, KVM Konfiguration"
---
...
1. **Host-الاتصال** (Orange Seite): Host-Computer مع 1,5m Type-C-Kabel verbinden
2. **Ziel-الاتصال** (Schwarze Seite): Zielgerät مع 0,3m Type-C-Kabel verbinden
3. **Video-الاتصال** (Schwarze Seite): Video-Ausgabe des Ziels an HDMI-Port anschließen
4. **USB-Gerät** (Optional): Nach Abschluss der Schritte 1-3 an USB-A-Port anschließen

!!! note "Anforderungen" - **Host**: Erfordert التثبيت von [Openterface App](/app) - **Ziel**: Keine App erforderlich - unterstützt Windows, macOS, Linux, Android, iOS - **Video**: Bereitgestelltes HDMI-Kabel أو VGA-to-HDMI-Konverter verwenden
...
- ① **Host USB-C**: Datenحولtragung zum Host-Computer
...
!!! warning "Wichtige Hinweise" - **Stromversorgung**: USB-Geräte sollten 1,5W Verbrauch لا حولschreiten - **USB-A-Verriegelung**: Erfordert zusätzliche Kraft zum Ein-/Ausschieben (kleine Geräte vermeiden) - **USB-Hub**: Nur extern versorgte Hubs verwenden; tiefe USB-Bäume vermeiden - **Umschaltung**: Siehe [USB-Port-Umschaltungsanleitung](../usb-switch) لـ Details
