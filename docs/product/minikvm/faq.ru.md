...
description: Häufig gestellte Вопросы zum Mini-KVM, die Функции, Kompatibilität, Fehlerbehebung и zukünftige Pläne abdecken.
...
Details siehe [Troubleshooting Tastatur- и Maussteuerung](/product/minikvm/support/keyboard-mouse-control/).
...
- **macOS:** [Diagnose Selbsttest Руководство (macOS)](/product/minikvm/support/diagnostic-self-check/) — Einstellungen → Erweitert & Debug → Diagnose-Tool öffnen
- **Windows:** [Diagnose Selbsttest Руководство (Windows)](/product/minikvm/support/diagnostic-self-check-windows/) — Erweitert → Оборудование-Diagnose
...
Schritt-для-Schritt-Руководство: [Diagnose Selbsttest Руководство (macOS)](/product/minikvm/support/diagnostic-self-check/) или [Diagnose Selbsttest Руководство (Windows)](/product/minikvm/support/diagnostic-self-check-windows/).

**:material-chat-question:{ .faq } USB-Hub-Probleme**

Verwenden Sie einen **aktiven Hub**, um Spannungsabfälle zu vermeiden. Unversorgte Hubs können zu unzureichender Stromversorgung и instabilem HID-Verhalten (Tastatur/Maus) führen. Details: [Troubleshooting Tastatur- и Maussteuerung](/product/minikvm/support/keyboard-mouse-control/).
...
2. [Troubleshooting Tastatur- и Maussteuerung](/product/minikvm/support/keyboard-mouse-control/) для HID-Probleme prüfen (Kabel, Hubs, HID-Reset).
3. [Diagnose-Selbsttest](/product/minikvm/support/diagnostic-self-check/) (macOS) или [Оборудование-Diagnose](/product/minikvm/support/diagnostic-self-check-windows/) (Windows) ausführen.
