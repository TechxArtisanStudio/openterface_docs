---
title: "擴展引腳"
description: "探索 Openterface Mini-KVM 擴展引腳在自定義硬件開發和開源項目中的潛力。"
...
!!! warning "保修失效"
    拆除原裝外殼可能導致產品保修失效。所有改裝或拆解行為均由用戶自行承擔風險。
...
該 3D 打印的擴展引腳蓋用於替換 Openterface Mini-KVM 的原裝上蓋，使高級用戶能夠暴露並訪問擴展引腳以進行自定義開發。你可以從我們的 GitHub 倉庫下載 3D 模型文件並自行打印此蓋子。
...
隨著我們不斷開發與實驗，我們將持續更新本節，介紹這些引腳的更多潛能及其創造性的使用方式。你的創意與專長將助力拓展 Openterface Mini-KVM 的可能性。歡迎參與：
