...
??? info "Schritte zur Behebung"
    ...
    1. **USB-Stromversorgung verbinden**
        - Stecken Sie den USB-Connector in einen с Strom versorgten USB-Port (wie den [umschaltbaren USB-Port](/product/minikvm/usb-switch/) des Mini-KVM или direkt in den Computer).
