...
??? info "Schritte zur Behebung"
    ...
    1. **USB-Stromversorgung verbinden**
        - Stecken Sie den USB-Connector in einen z Strom versorgten USB-Port (wie den [umschaltbaren USB-Port](/product/minikvm/usb-switch/) des Mini-KVM lub direkt in den Computer).
