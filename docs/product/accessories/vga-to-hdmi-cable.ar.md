...
??? info "Schritte zur Behebung"
    ...
    1. **USB-Stromversorgung verbinden**
        - Stecken Sie den USB-Connector in einen مع Strom versorgten USB-Port (wie den [umschaltbaren USB-Port](/product/minikvm/usb-switch/) des Mini-KVM أو direkt in den Computer).
