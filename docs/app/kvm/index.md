...
-   ### :fontawesome-brands-windows:{ .lg } **Windows**
    ...
    ***
    ...
    [:octicons-download-24: Download {{qt_version}} AMD64 Installer](https://github.com/TechxArtisanStudio/Openterface_QT/releases/download/{{qt_version}}/openterfaceQT_windows_amd64_installer.exe) <br>
    [:octicons-download-24: Download {{qt_version}} AMD64 Portable EXE](https://github.com/TechxArtisanStudio/Openterface_QT/releases/download/{{qt_version}}/openterfaceQT_windows_amd64_portable.exe) <br>
...
-   ### :fontawesome-brands-linux:{ .lg } **Linux**
    ...
    ***
    ...
    [:octicons-download-24: Download {{qt_version}} ARM64 RPM](https://github.com/TechxArtisanStudio/Openterface_QT/releases/download/{{qt_version}}/openterfaceQT_linux_arm64.rpm) <br>
...
-   ### :fontawesome-brands-android:{ .lg } **Android**
    ...
    ***
    ...
    [:octicons-download-24: Download {{android_version}} APK](https://github.com/TechxArtisanStudio/Openterface_Android/releases/download/{{android_version}}/Openterface-{{android_version}}-release.apk) <br>
