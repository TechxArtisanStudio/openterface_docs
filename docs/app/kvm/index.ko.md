---
title: "소프트웨어"
description: Openterface™ KVM 가젯을 실행하려면 호스트 컴퓨터에 아래 나열된 앱 중 하나를 설치해야 합니다. 다양한 앱 플랫폼에서 이러한 앱을 다운로드하거나 제공된 링크를 클릭할 수 있습니다. 모험을 즐긴다면 GitHub 저장소를 사용하여 소스에서 직접 빌드할 수도 있습니다!
---
...
-   ### :fontawesome-brands-android:{ .lg } **Android**
    ...
    **Android APK**용 다운로드 또는 소스에서 빌드:
    ...
    [:octicons-download-24: {{android_version}} 다운로드](https://github.com/TechxArtisanStudio/Openterface_Android/releases/download/{{android_version}}/Openterface-{{android_version}}-release.apk) <br>
