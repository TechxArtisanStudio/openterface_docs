...
-   ### :fontawesome-brands-apple:{ .lg } **macOS**
    ...
    ***
    ...
    [:octicons-download-24: Télécharger le DMG portable](/app/macos/dmg-installation.md) <br>
...
-   ### :fontawesome-brands-android:{ .lg } **Android**
    ...
    ***
    ...
    [:octicons-download-24: Télécharger {{android_version}}](https://github.com/TechxArtisanStudio/Openterface_Android/releases/download/{{android_version}}/Openterface-{{android_version}}-release.apk) <br>
