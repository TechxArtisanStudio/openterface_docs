---
title: "ソフトウェア"
description: "Openterface ホストアプリの概要 — Mini-KVM・KVM-GO 向け macOS、Windows、Linux、Android、iPadOS 版のダウンロード、インストール、更新情報。公式ドキュメント。"
---
...
-   ### :fontawesome-brands-apple:{ .lg } **macOS**
    ...
    **Openterface MacOS**をダウンロードまたはソースからビルド：
    ...
    [:octicons-download-24: ポータブル DMG をダウンロード](/app/macos/dmg-installation.md) <br>
