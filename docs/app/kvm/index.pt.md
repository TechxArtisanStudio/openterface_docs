---
title: "Software"
description: Para colocar seus gadgets Openterface™ KVM em funcionamento, você precisará instalar um dos aplicativos listados abaixo no seu computador host. Você pode…
---
...
-   ### :fontawesome-brands-android:{ .lg } **Android**
    ...
    ***
    ...
    [:octicons-download-24: Baixar {{android_version}}](https://github.com/TechxArtisanStudio/Openterface_Android/releases/download/{{android_version}}/Openterface-{{android_version}}-release.apk) <br>
