...
description: "Install OpenterfaceQT on Arch Linux with the native pacman package (.pkg.tar.zst). Uses system Qt6/FFmpeg/GStreamer, auto-installs dependencies, configures udev rules, supports x86_64 and ARM64."
---

# Arch Linux Installation Guide

This guide covers installing OpenterfaceQT on Arch Linux (rolling release) using the native pacman package.
...
The PKGBUILD ([`packaging/archlinux/PKGBUILD`](https://github.com/TechxArtisanStudio/Openterface_QT/blob/main/packaging/archlinux/PKGBUILD)) builds the package with these key CMake flags:
...
- [Building from Source](https://github.com/TechxArtisanStudio/Openterface_QT/blob/main/docs/BUILD.md) — all platforms
- [Runtime Dependencies](https://github.com/TechxArtisanStudio/Openterface_QT/blob/main/docs/dependencies.md) — full reference
